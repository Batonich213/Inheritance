...
namespace Geometry
{
	...
	enum Color
	{
		//0x - Hexadecimal (Øåñòíàäöàòåðè÷íàÿ ñèñòåìà ñ÷èñëåíèÿ)
		red = 0x000000FF,
		green = 0x0000FF00,
		blue = 0x00FF0000,
		yellow = 0x00FFFF,
...
#define SHAPE_GIVE_PARAMETERS start_x, start_y, line_width, color
	...
	public:
		...
		void draw()const override
		{
			...
			HDC hdc = GetDC(hwnd);
			HPEN hPen = CreatePen(PS_SOLID, line_width, color);	//Êàðàíäàø ðèñóåò êîíòóð ôèãóðû
	...
	public:
		...
		{
			cout << typeid(*this).name() << endl;
			cout << "Êàòåò 1:	 " << side1 << endl;
			cout << "Êàòåò 2:	 " << side2 << endl;
			cout << "Ãèïîòåíóçà: " << get_hypotenuse() << endl;
			Triangle::info();
