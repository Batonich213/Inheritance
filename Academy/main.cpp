...
public:
	...
	{
		Human::info();
		cout << speciality << " " << experience << " ëåò.\n";
	}
	std::ostream& print(std::ostream& os)const override
	{
...
#define POLYMORPHISM	//(ìíîãîôîðìåííîñòü)
...
void main()
{
	...
	Graduate graduate("Ïåòðîâ", "Íèêîëàé", 21, "IT", "PV_211", 10, 80, "Îðãàíèçàöèÿ çàùèòû áåçîïàñíîñòè ÷åòîòàì ñåòè");
	graduate.info();
	...
	/*
		1. Pointers to base class;	//Generalisation - Îáîáùåíèå
		2. Virtual functions;
	*/
	...
	//delete[] group;	//Ïðè óäàëåíèè ñòàòè÷åñêîé ïàìÿòè âûëåòàåò Debug Assertion Failed
}